...
def lazy_import():
    ...
    globals()['KPIAreaPerformanceForResponse'] = KPIAreaPerformanceForResponse


class PageKPIAreaPerformanceForResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([KPIAreaPerformanceForResponse],),  # noqa: E501
            'total': (int,),  # noqa: E501
            'page': (int,),  # noqa: E501
            'size': (int,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, total, page, size, *args, **kwargs):  # noqa: E501
        """PageKPIAreaPerformanceForResponse - a model defined in OpenAPI

        Args:
            items ([KPIAreaPerformanceForResponse]):
            total (int):
            page (int):
            size (int):
