...
def lazy_import():
    ...
    globals()['BotEventForResponse'] = BotEventForResponse


class PageBotEventForResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([BotEventForResponse],),  # noqa: E501
            'total': (int,),  # noqa: E501
            'page': (int,),  # noqa: E501
            'size': (int,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, total, page, size, *args, **kwargs):  # noqa: E501
        """PageBotEventForResponse - a model defined in OpenAPI

        Args:
            items ([BotEventForResponse]):
            total (int):
            page (int):
            size (int):
