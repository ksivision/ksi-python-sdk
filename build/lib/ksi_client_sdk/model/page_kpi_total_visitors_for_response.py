...
def lazy_import():
    ...
    globals()['KPITotalVisitorsForResponse'] = KPITotalVisitorsForResponse


class PageKPITotalVisitorsForResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([KPITotalVisitorsForResponse],),  # noqa: E501
            'total': (int,),  # noqa: E501
            'page': (int,),  # noqa: E501
            'size': (int,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, total, page, size, *args, **kwargs):  # noqa: E501
        """PageKPITotalVisitorsForResponse - a model defined in OpenAPI

        Args:
            items ([KPITotalVisitorsForResponse]):
            total (int):
            page (int):
            size (int):
