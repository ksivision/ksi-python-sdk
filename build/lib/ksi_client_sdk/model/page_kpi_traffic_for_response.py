...
def lazy_import():
    ...
    globals()['KPITrafficForResponse'] = KPITrafficForResponse


class PageKPITrafficForResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([KPITrafficForResponse],),  # noqa: E501
            'total': (int,),  # noqa: E501
            'page': (int,),  # noqa: E501
            'size': (int,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, total, page, size, *args, **kwargs):  # noqa: E501
        """PageKPITrafficForResponse - a model defined in OpenAPI

        Args:
            items ([KPITrafficForResponse]):
            total (int):
            page (int):
            size (int):
