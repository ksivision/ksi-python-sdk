...
def lazy_import():
    ...
    globals()['NodeDetectionObject'] = NodeDetectionObject


class NodeDetectionsRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'camera_id': (int,),  # noqa: E501
            'timestamp': (datetime,),  # noqa: E501
            'objects': ([NodeDetectionObject],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, camera_id, timestamp, objects, *args, **kwargs):  # noqa: E501
        """NodeDetectionsRequest - a model defined in OpenAPI

        Args:
            camera_id (int):
            timestamp (datetime):
            objects ([NodeDetectionObject]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, camera_id, timestamp, objects, *args, **kwargs):  # noqa: E501
        """NodeDetectionsRequest - a model defined in OpenAPI
