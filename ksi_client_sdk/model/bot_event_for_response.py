...
class BotEventForResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, start_date, end_date, description, observation, bot_id, *args, **kwargs):  # noqa: E501
        """BotEventForResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            labels (str): [optional] if omitted the server will use the default value of ""  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, start_date, end_date, description, observation, bot_id, *args, **kwargs):  # noqa: E501
        """BotEventForResponse - a model defined in OpenAPI
