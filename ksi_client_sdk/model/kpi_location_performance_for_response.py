...
class KPILocationPerformanceForResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time, sum_impressions, avg_dwell_time, location_id, *args, **kwargs):  # noqa: E501
        """KPILocationPerformanceForResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, time, sum_impressions, avg_dwell_time, location_id, *args, **kwargs):  # noqa: E501
        """KPILocationPerformanceForResponse - a model defined in OpenAPI
