...
def lazy_import():
    ...
    globals()['KPILocationPersonsCountResponse'] = KPILocationPersonsCountResponse


class PageKPILocationPersonsCountResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([KPILocationPersonsCountResponse],),  # noqa: E501
            'total': (int,),  # noqa: E501
            'page': (int,),  # noqa: E501
            'size': (int,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, total, page, size, *args, **kwargs):  # noqa: E501
        """PageKPILocationPersonsCountResponse - a model defined in OpenAPI

        Args:
            items ([KPILocationPersonsCountResponse]):
            total (int):
            page (int):
            size (int):
