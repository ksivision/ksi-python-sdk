...
class TimeBucket(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TimeBucket - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): An enumeration.., must be one of ["1 hour", "1 day", "1 week", "1 month", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["1 hour", "1 day", "1 week", "1 month", ]  # noqa: E501
