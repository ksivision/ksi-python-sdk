...
class LocationRoutesForResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, location_id, person_id, route, *args, **kwargs):  # noqa: E501
        """LocationRoutesForResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, location_id, person_id, route, *args, **kwargs):  # noqa: E501
        """LocationRoutesForResponse - a model defined in OpenAPI
