...
from ksi_client_sdk import rest
from ksi_client_sdk.configuration import Configuration
from ksi_client_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from ksi_client_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BotsApi()
        api_instance.get_all_bots_api_bots_get  # this is an instance of the class Endpoint
        api_instance.get_all_bots_api_bots_get()  # this invokes api_instance.get_all_bots_api_bots_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_all_bots_api_bots_get.callable or self.callable in this class
